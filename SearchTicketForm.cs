...
namespace Fly
{
    ...
    public partial class SearchTicketForm : Form
    {
        ...
        private void form_details_Load(object sender, EventArgs e)
        {
            ...
            //ID is made up of the flight ID, seats available on the flight at the time of booking and the time.
            _ticketId = $"fly_{_selectedFlight.FlightId}{_selectedFlight.SeatsAvailable}{DateTime.UtcNow:ddMMyyHms}";
            txtBox_ticketNumber.Text = _ticketId;
